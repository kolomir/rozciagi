 ...
 */
function(e){
"function"==typeof define&&n(55)?define(["jquery","datatables.net"],
(function(t){return e(t,window,document)})):"object"===("undefined"==typeof exports?"undefined":r(exports))?t.exports=function(t,r)
{return t||(t=window),r&&r.fn.dataTable||(r=n(136)(t,r).$),e(r,t,t.document)}:e(jQuery,window,document)}
((function(t,e,n,r){var a=t.fn.dataTable;return t.extend(!0,a.defaults,
...
t.extend(a.ext.classes,{sWrapper:"dataTables_wrapper dt-bootstrap4",sFilterInput:"form-control form-control-sm",
sLengthSelect:"custom-select custom-select-sm form-control form-control-sm",sProcessing:"dataTables_processing card",sPageButton:"paginate_button page-item"}),
a.ext.renderer.pageButton.bootstrap=function(e,o,i,s,l,u){var c,f,d,h=new a.Api(e),p=e.oClasses,g=e.oLanguage.oPaginate,v=e.oLanguage.oAria.paginate||{},b=0;
try{d=t(o).find(n.activeElement).data("dt-idx")}catch(t){}!function n(r,a){var o,s,d,y,m=function(e){e.preventDefault(),t(e.currentTarget).hasClass("disabled")||
h.page()==e.data.action||h.page(e.data.action).draw("page")};for(o=0,s=a.length;o<s;o++)if(y=a[o],t.isArray(y))n(r,y);else{switch(c="",f="",y)
{case"ellipsis":c="&#x2026;",f="disabled";break;case"first":c=g.sFirst,f=y+(l>0?"":" disabled");break;case"previous":c=g.sPrevious,f=y+(l>0?"":" disabled");
break;case"next":c=g.sNext,f=y+(l<u-1?"":" disabled");break;case"last":c=g.sLast,f=y+(l<u-1?"":" disabled");break;default:c=y+1,f=l===y?"active":""}c&&
(d=t("<li>",{class:p.sPageButton+" "+f,id:0===i&&"string"==typeof y?e.sTableId+"_"+y:null}).append(t("<a>",{href:"#","aria-controls":e.sTableId,"aria-label":v[y],
"data-dt-idx":b,tabindex:e.iTabIndex,class:"page-link"}).html(c)).appendTo(r),e.oApi._fnBindAction(d,{action:y},m),b++)}}(t(o).empty().html
('<ul class="pagination"/>').children("ul"),s),d!==r&&t(o).find("[data-dt-idx="+d+"]").focus()},a}))}.call(this,n(87)(t))},function(t,e,n)
{var r=n(3),a=n(131);r({target:"Array",proto:!0,forced:a!==[].lastIndexOf},{lastIndexOf:a})},function(t,e,n){"use strict";var r=n(3),a=n(111).right;r
({target:"Array",proto:!0,forced:n(51)("reduceRight")},{reduceRight:function(t){return a(this,t,arguments.length,arguments.length>1?arguments[1]:void 0)}})},
function(t,e,n){"use strict";var r=n(82),a=n(7),o=n(13),i=n(205),s=n(83);r("search",1,(function(t,e,n){return[function(e){var n=o(this),r=null==e?void 0:e[t];
return void 0!==r?r.call(e,n):new RegExp(e)[t](String(n))},function(t){var r=n(e,t,this);if(r.done)return r.value;var o=a(t),l=String(this),u=o.lastIndex;i(u,0)||(o.lastIndex=0);var c=s(o,l);return i(o.lastIndex,u)||(o.lastIndex=u),null===c?-1:c.index}]}))},function(t,e){t.exports=Object.is||function(t,e){return t===e?0!==t||1/t==1/e:t!=t&&e!=e}},function(t,e,n){"use strict";var r=n(3),a=n(91).trim;r({target:"String",proto:!0,forced:n(207)("trim")},{trim:function(){return a(this)}})},function(t,e,n){var r=n(1),a=n(74);t.exports=function(t){return r((function(){return!!a[t]()||"​᠎"!="​᠎"[t]()||a[t].name!==t}))}},function(t,e,n){}]);
}
